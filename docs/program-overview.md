# {PROJECT_NAME} — Программа студенческой практики
...
`{PROJECT_NAME}` — учебный симулятор процессингового центра на микросервисной архитектуре. Проект эмулирует полный путь банковской транзакции:
