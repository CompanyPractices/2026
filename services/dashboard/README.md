...
> Web Dashboard — это фронтенд-сервис процессингового центра, который отображает ключевые метрики транзакций (KPI-карточки), графики динамики и таблицу последних операций в режиме реального времени.
