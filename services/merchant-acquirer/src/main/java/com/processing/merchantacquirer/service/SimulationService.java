...
public class SimulationService {
    ...
    public SimulatorResponse run(SimulatorRequest request){
        ...
        // Создание транакций
        List<AuthorizationRequest> authorizationRequests = List.of();
        ...
        List<AuthorizationResponse> authorizationResponses = List.of();
        for(AuthorizationRequest transaction: authorizationRequests){
            try {
                ...
                authorizationResponses.add(new AuthorizationResponse("", " ", " ", " ", " ", " ", 999));
                declined += 1;
            }
        }
